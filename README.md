...
* **capacityOnNumTx.m** - строит зависмость средней пропускной способности от отношения числа антенн на передачу к числу на приеме. 

* **capacityOnNumTx2.m** - строит зависмость средней пропускной способности с пространственной корреляцией и без нее. 

* **capacityOnXPR.m** - строит зависмость средней пропускной способности от кроссполяризации (XPR)
